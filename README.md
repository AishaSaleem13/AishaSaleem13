...
### 💡 About Me
- 🚀 Currently exploring **Backend + Mobile App Development**
- 💻 Love creating clean, functional, and scalable code  
- 🌱 Learning **FastAPI** and **React Native**
- 🧠 Interested in **AI + Open Source Projects**
- ⚙️ I believe every bug teaches something new  
...
`HTML5` • `CSS3` • `JavaScript (ES6+)` • `Node.js` • `Express.js` • `React.js` • `Tailwind CSS` • `MongoDB`

#### 🧩 Tools & Platforms  
`Git` • `GitHub` • `Postman` • `VS Code` • `Vercel` • `Firebase`
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=FACC15&height=100&section=footer"/>
</p>
